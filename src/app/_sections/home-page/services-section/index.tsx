	...
	return (
		<section className="ServicesSection">
			...
			<p className="ServicesSection__desc">
				Pružamo širok spektar usluga selidbe kako bismo vam omogućili glatku i bezbrižnu tranziciju u vaš novi dom ili poslovni prostor. Bez
				obzira na obim selidbe ili udaljenost, mi smo tu da vam pomognemo.
			</p>

			<div className="ServicesSection__content">
				<div className="ServicesSection__wrapper">
					<Link href={'/services'}>
						<Image src={Movers} className="ServicesSection__img" alt="Selidbe" />
						<h5 className="ServicesSection__text">Selidbe</h5>
					</Link>
				</div>
				<div className="ServicesSection__wrapper">
					<Link href={'/services'}>
						<Image src={Truck} className="ServicesSection__img" alt="Selidbe i Transport" />
						<h5 className="ServicesSection__text">Transport</h5>
					</Link>
				</div>
				<div className="ServicesSection__wrapper">
					<Link href={'/services'}>
						<Image src={Worker} className="ServicesSection__img" alt="Selidbe Demontaza" />
						<h5 className="ServicesSection__text">Demontaža</h5>
					</Link>
				</div>
				<div className="ServicesSection__wrapper">
					<Link href={'/services'}>
						<Image src={Box} className="ServicesSection__img" alt="Selidbe i Prodaja Opreme" />
						<h5 className="ServicesSection__text">Prodaja opreme za selidbe</h5>
					</Link>
				</div>
				<div className="ServicesSection__wrapper">
					<Link href={'/services'}>
						<Image src={Moving} className="ServicesSection__img" alt="Selidbe Beograd" />
