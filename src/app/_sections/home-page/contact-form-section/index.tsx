...
export function ContactFormSection() {
  const [contactForm, setContactForm] =
    useState<ContactFormModel>(DEFAULT_FORM);

  const onChange = (
    e: ChangeEvent<HTMLInputElement | HTMLTextAreaElement>,
    inputKey: keyof ContactFormModel
  ) => {
  ...
  return (
    <section className="ContactForm">
      ...
      <div className="ContactForm__text">
        ...
        <p>
          Kontaktirajte nas za besplatnu procenu naših usluga. Takodje možete
          nam postaviti pitanje ako imate nedoumica. Naš tim će vam odgovoriti u
          što kraćem roku.
        </p>
      </div>
